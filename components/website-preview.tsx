      ...
      <AnimatePresence>
        {showNewsletter && (
          <>
            ...
            />
            <motion.div
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl p-8 max-w-md w-full z-50"
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.8, opacity: 0 }}
              transition={{ type: "spring", damping: 25, stiffness: 300 }}
            >
              <button className="absolute top-2 right-2 text-gray-400 hover:text-gray-600" onClick={closeNewsletter}>
                <X size={24} />
              </button>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">{t.getDiscount}</p>
