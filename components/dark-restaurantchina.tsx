      ...
      <footer className="py-12 bg-black border-t border-zinc-900">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-zinc-400 mb-4">
                Authentic Japanese cuisine in a modern atmosphere. Experience the true taste of Japan.
              </p>
              <div className="flex space-x-4">
                {[
                  ...
                  <a key={index} href="#" className="text-zinc-400 hover:text-orange-500 transition-colors">
                    {icon}
                  </a>
                ))}
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-zinc-400">
                <li className="flex items-start gap-2">
                  ...
                  <span>123 Ramen St., Noodle District</span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-zinc-400 mb-4">Subscribe to our newsletter for the latest updates and offers.</p>
              <div className="flex">
                <Input
                  placeholder="Your email"
                  className="bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-500 focus:border-orange-500 rounded-r-none"
                />
                <Button className="bg-orange-600 hover:bg-orange-700 text-white rounded-l-none">
          ...
          <div className="border-t border-zinc-900 mt-12 pt-8 text-center text-zinc-500 text-sm">
            <p>© {new Date().getFullYear()} UMAMI Ramen. All rights reserved.</p>
          </div>
        </div>
      </footer>
